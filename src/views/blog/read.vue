  ...
  <main class="w-full">
    ...
    <div class="container m-auto max-w-screen-lg min-h-min px-1 md:px-4 my-10 md:my-14">
      ...
      <div class="mb-10 mx-2 md:mx-0">
        ...
        <div class="text-gray-400 text-xs md:text-sm"><i class="far fa-calendar-alt mr-2"></i><span v-html="blogDate(article.created_at)"></span></div>
      </div>
      ...
      <div class="mx-2 md:mx-0">
        ...
        <!-- 업데이트 내역 -->
        <p class="mt-10 text-sm text-gray-600">이 글은 <span v-html="blogDate(article.updated_at)"></span>에 마지막으로 수정했습니다.</p>
        <!-- 목록 버튼 -->
